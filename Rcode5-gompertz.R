...
# and adding in the intercept explicitly into the lp (lp = linear predictor) 
# object above using the predict.coxph(..., type = "lp")
...
pdf(file = "fig_lifespan-density.pdf", width = 8, height = 6)
par(mfrow = c(1, 1))
...
dev.off()
# Pretty high expected lifespans.
# could be result of:
#   (1) AARP filter (selection bias)
#   (2) 16% response rate (non-response bias) and
#   (3) excluding chronically ill people (25% of subjects discarded)
