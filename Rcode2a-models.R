...
save(M0, file = paste0(data.path, "M0.RData"))
save(M1, file = paste0(data.path, "M1.RData"))
save(M2, file = paste0(data.path, "M2.RData"))
save(M3, file = paste0(data.path, "M3.RData"))
save(M4, file = paste0(data.path, "M4.RData"))
save(M5, file = paste0(data.path, "M5.RData"))
save(M6, file = paste0(data.path, "M6.RData"))

# save the input matrix for M3:
save(dt, file = paste0(data.path, "dt.RData"))

# save the loglikelihood sequence:
save(alpha.seq.ix, file = "alpha_seq_ix.RData")
