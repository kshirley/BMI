...
t2 <- Sys.time()
t2 - t1  # 7.7 minutes on macbook air
...
# using bmi.mean = 27.05 and bmi.sd = 4.644:
...
save(pob.scaled, file = "pob_scaled.RData")
save(ci, file = "ci_derivative.RData")
